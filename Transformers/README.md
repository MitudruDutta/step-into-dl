...
| #   | Topic                                                           | Description                                                    |
| :-- | :-------------------------------------------------------------- | :------------------------------------------------------------- |
| 1   | [Word Embeddings](docs/01-Word-Embeddings.md)                   | How words become vectors that capture semantic meaning         |
| 2   | [Architecture Overview](docs/02-Architecture-Overview.md)       | Encoder, Decoder, and their variants (BERT vs GPT vs T5)       |
| 3   | [Attention Mechanism](docs/03-Attention-Mechanism.md)           | The core innovation: Query, Key, Value, and scaled dot-product |
| 4   | [Multi-Head Attention](docs/04-Multi-Head-Attention.md)         | How multiple attention heads capture diverse patterns          |
| 5   | [Decoder Mechanics](docs/05-Decoder-Mechanics.md)               | Masked self-attention and cross-attention for generation       |
| 6   | [Self-Supervised Training](docs/06-Self-Supervised-Training.md) | CLM (GPT-style) vs MLM (BERT-style) training                   |
...
_Start with [01-Word-Embeddings.md](docs/01-Word-Embeddings.md) to begin your journey!_ 🎓
